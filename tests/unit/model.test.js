...
describe('TodoService Unit Tests', () => {
    ...
    test('should add a new todo', () => {
        ...
        const textInput = 'Học Unit Test với Jest';
        service.addTodo(textInput);
        expect(service.todos).toHaveLength(1);
        expect(service.todos[0].text).toBe(textInput);
    });
    ...
    test('should remove a todo', () => {
        ...
        service.addTodo('Nghiên cứu khoa học');
        const todoId = service.todos[0].id;
